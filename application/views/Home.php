...
<head>
	...
	<script type="text/javascript" src="<?php echo base_url() ?>template/frontend/vendor2/bootstrap.js"></script>


	<script type="text/javascript" src="<?php echo base_url() ?>template/frontend/vendor2/isotope.pkgd.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url() ?>template/frontend/vendor2/imagesloaded.pkgd.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url() ?>template/frontend/1.js"></script>

	<link rel="stylesheet" href="<?php echo base_url() ?>template/frontend/vendor2/bootstrap.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>template/frontend/vendor2/font-awesome.css">
	<link rel="stylesheet" href="<?php echo base_url() ?>template/frontend/1.css">
</head>
				...
				<?php foreach ($mangdl as $key => $value) : ?>
					...
					<div class="carousel-item
						...
						<div class="chu">
							...
							<a href="<?= $value['button_link'] ?>" class="fontoswarld nutslide btn btn-warning"> <?= $value['button_text'] ?></a>
						</div>
